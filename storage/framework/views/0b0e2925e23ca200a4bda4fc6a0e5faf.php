<?php $__env->startSection('title', 'Assets List - SiAPPMan'); ?>
...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="<?php echo e(route('dashboard.assets.create')); ?>" class="btn btn-primary">
    ...
    <div style="margin-bottom: 2rem;">
        <form action="<?php echo e(route('dashboard.assets.index')); ?>" method="GET">
            <div style="display: flex; gap: 1rem;">
            <input type="text" name="search" placeholder="Cari berdasarkan nama aset..." value="<?php echo e(request('search')); ?>" style="flex-grow: 1; padding: 0.75rem 1rem; border: 1px solid var(--gray-300); border-radius: 0.5rem;">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-bottom: 1px solid var(--gray-100);">
                                    <td style="padding: 1rem; color: var(--gray-900); font-weight: 500;"><?php echo e($asset->name); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->instrument_type); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->unit); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->unit_code); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->destination_unit); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->destination_unit_code); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->jumlah); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->jumlah_steril ?? 0); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->jumlah_kotor ?? 0); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->jumlah_proses_cssd ?? 0); ?></td>
                                    <td style="padding: 1rem; color: var(--gray-600);"><?php echo e($asset->location); ?></td>
                                    ...
                                    <td style="padding: 1rem;">
                                        <div style="display: flex; gap: 0.5rem;">
                                            <a href="<?php echo e(route('dashboard.assets.show', $asset)); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.875rem;">Lihat</a>
                                            <a href="<?php echo e(route('dashboard.assets.edit', $asset)); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.875rem;">Edit</a>
                                            <button onclick="showQRModal(<?php echo e($asset->id); ?>, '<?php echo e($asset->name); ?>', '<?php echo e($asset->instrument_type); ?>', '<?php echo e($asset->location); ?>', '<?php echo e($asset->qr_code); ?>')" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.875rem;">QR</button>
                                            <form method="POST" action="<?php echo e(route('dashboard.assets.destroy', $asset)); ?>" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus aset ini?')">
                                                <?php echo csrf_field(); ?>
        ...
        <div class="card">
            <div class="card-body">
                <div style="text-align: center; color: var(--gray-500); padding: 3rem;">
                    ...
                    <a href="<?php echo e(route('dashboard.assets.create')); ?>" class="btn btn-primary">Tambah Aset Pertama Anda</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\siappman-backend-fix-qr-code-uniqueness\resources\views/dashboard/assets/index.blade.php ENDPATH**/ ?>