...
<div class="container" style="max-width: 400px; margin: 4rem auto;">
    <div class="card">
        <div class="card-header" style="text-align: center;">
            ...
            <p style="margin: 0.5rem 0 0 0; color: var(--muted-foreground);">Masuk ke akun Anda</p>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group" style="display: flex; align-items: center;">
                    ...
                    <label for="remember" style="margin: 0; font-size: 0.875rem; color: var(--muted-foreground);">Ingat Saya!</label>
                </div>
            ...
            <div style="text-align: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--border);">
                <p style="margin: 0; color: var(--muted-foreground); font-size: 0.875rem;">
                    Belum punya akun?
                    <a href="{{ route('register') }}" style="color: var(--primary); text-decoration: none; font-weight: 500;">Mendaftar</a>
                </p>
            </div>
        </div>
    </div>
