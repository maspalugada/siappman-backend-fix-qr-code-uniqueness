...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="{{ route('dashboard.units.create') }}" class="btn btn-primary">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse ($units as $unit)
                            <tr>
                                <td>
                                    <div style="font-weight: 500; color: var(--gray-900);">{{ $unit->name }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.25rem;">
                                        <a href="{{ route('dashboard.units.edit', $unit) }}" class="btn btn-sm btn-warning" title="Edit Unit">
                                        ...
                                        <form action="{{ route('dashboard.units.destroy', $unit) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus unit ini?');">
                                            @csrf
                                            @method('DELETE')
