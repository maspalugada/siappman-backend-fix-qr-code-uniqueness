...
@section('title', 'Tambah Unit Baru - SiAPPMan')
    ...
    <div style="margin-bottom: 2rem;">
        <nav style="margin-bottom: 1rem;">
            <ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center; gap: 0.5rem; font-size: 0.875rem; color: var(--gray-500);">
                ...
                <li style="color: var(--gray-400);">/</li>
                <li style="color: var(--gray-900); font-weight: 500;">Tambah Baru</li>
            </ol>
        </nav>
        <h1 style="font-size: 2rem; font-weight: 700; color: var(--gray-900); margin-bottom: 0.5rem;">Tambah Unit Baru</h1>
        <p style="color: var(--gray-600);">Buat unit baru untuk mengelola aset</p>
    </div>

    <div class="card">
        <div class="card-header">
            <h3 style="font-size: 1.25rem; font-weight: 600; color: var(--gray-900); margin: 0;">Form Tambah Unit</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.units.store') }}">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-input" value="{{ old('name') }}" placeholder="Masukkan nama unit" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" class="form-input" value="{{ old('code') }}" placeholder="Masukkan kode unit">
                        @error('code')
                            <div style="color: var(--error); font-size: 0.875rem; margin-top: 0.25rem; display: flex; align-items: center;">
                                <svg width="14" height="14" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 0.25rem;">
                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                ...
                <div style="margin-top: 2rem; padding: 1.5rem; background-color: var(--gray-50); border-radius: 0.5rem; border: 1px solid var(--gray-200);">
                    <h4 style="font-size: 1rem; font-weight: 600; color: var(--gray-900); margin-bottom: 0.5rem; display: flex; align-items: center;">
                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 0.5rem; color: var(--primary-color);">
                            <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                        </svg>
                        Informasi
                    </h4>
                    <ul style="color: var(--gray-600); font-size: 0.875rem; margin: 0; padding-left: 1.5rem;">
                        <li style="margin-bottom: 0.25rem;">Unit digunakan untuk mengkategorikan aset berdasarkan lokasi atau departemen</li>
                        <li style="margin-bottom: 0.25rem;">Nama unit harus unik dan deskriptif</li>
                        <li>Kode unit bersifat opsional dan dapat digunakan untuk referensi cepat</li>
                    </ul>
                </div>
